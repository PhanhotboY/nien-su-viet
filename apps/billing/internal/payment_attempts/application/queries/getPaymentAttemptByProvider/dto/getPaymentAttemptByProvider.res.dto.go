...
type GetPaymentAttemptByProviderResDto interface {
...
type getPaymentAttemptByProviderResDto struct {
	Data PaymentAttemptData `json:"data"`
}

func NewGetPaymentAttemptByProviderResDto(entity entity.PaymentAttempt) GetPaymentAttemptByProviderResDto {
	...
	return &getPaymentAttemptByProviderResDto{
		Data: paymentAttempt,
	}
}

func (dto *getPaymentAttemptByProviderResDto) ToGrpcResponse() *billing_service.GetPaymentAttemptResponse {
...
func (dto *getPaymentAttemptByProviderResDto) GetData() PaymentAttemptData {
	return dto.Data
}
