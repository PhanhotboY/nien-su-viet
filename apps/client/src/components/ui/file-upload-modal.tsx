...
import { uploadImagesClient } from '@/services/image.client';
...
const FileUploadModal: FC<FileUploadModalProps> = ({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append('folder', folderName || 'nien-su-viet');
      ...
      const uploadedImages = await uploadImagesClient(formData);
      uploadedImages.forEach((img) => {
        uploadedUrls.push(img.img_url);
      });
